      ...
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 bg-white dark:bg-[#0C0C0E]">
        <div className="w-full max-w-[380px]">
          ...
          <form className="space-y-5" onSubmit={handleLogin}>
            ...
            {/* OAuth buttons (disabled — future) */}
            <button type="button" disabled className="w-full h-[44px] rounded-lg border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 opacity-50 cursor-not-allowed flex items-center justify-center gap-2" title="Coming soon">
            ...
            <button type="button" disabled className="w-full h-[44px] rounded-lg border border-gray-200 dark:border-gray-700 text-sm font-medium text-gray-700 dark:text-gray-300 opacity-50 cursor-not-allowed flex items-center justify-center gap-2" title="Coming soon">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M3 3h8.5v8.5H3V3zm9.5 0H21v8.5h-8.5V3zM3 12.5h8.5V21H3v-8.5zm9.5 0H21V21h-8.5v-8.5z"/></svg>
